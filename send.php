...
do {
    ...
    $mail->CharSet = 'UTF-8';
    $mail->FromName = '金老师';//发件人姓名
    $mail->Username = '317847781';//qq邮箱账号
    $mail->Password = 'qkbasgowfgrebgdg';//qq邮箱客户端授权码
    $mail->From = '317847781@qq.com';
    $mail->isHTML(true);
    $mail->addAddress('986133435@qq.com', '金同学');
